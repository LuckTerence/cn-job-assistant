...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.2.2-blue.svg" alt="1.2.2">
</p>
...
| **1.2.0** | ✅ | **quality_gate 投前门禁** · 改这3条 · **match-outcome** · ATS 清单 · 双格式 md/pdf |
| **1.2.1** | ✅ | 诚信误杀修复 · serve 精确改状态 · 看板匹配卡片 · 打分缓存 · demo 全接线 |
| **1.2.2** | ✅ | apply_assist 写分提示 · `make release-gh` · flow gate 门槛透传 |
