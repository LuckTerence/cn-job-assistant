...
> **说明**：本文档由原 `README.zh.md` 中的多轮对标 / 许可证核验 / 缺陷记录归档而来，供维护者查阅。  
> **新用户请读产品首页** → [README.md](../README.md)。  
> 能力边界与架构 → [ARCHITECTURE.zh.md](../ARCHITECTURE.zh.md)、[integrations/catalog/README.md](../integrations/catalog/README.md)。

---

# （归档）AI 求职助手 · 国内适配版（China Fork）
